...
export default function TaskModalDetails() {
    ...
    if(isError) {
        toast.error(error.message, {toastId: 'error'}) /* "toastId" detect the id, so it won't re-render unnecessary */
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-16">
                                    ...
                                    {data.completedBy.length ? (
                                        <>
                                            <p className='font-bold text-2xl text-slate-600 my-5'>Changes History</p>
                                    ...
                                    <div className='my-5 space-y-3'>
                                        ...
                                        >
                                            {/* We convert the Object into an array, and we'll iterate throgh it with the kry and value */}
